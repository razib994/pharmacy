                ...
                <div class="card-body">
                    ...
                    <div class="row">
                       ...
                       <div class="form-group col-lg-4">
                          ...
                          <input type="text" value="{{ $sale_invoices->customer->name }}" class="form-control">
                          <input type="hidden" name="customer_id" value="{{ $sale_invoices->customer_id }}" class="form-control">
                           @error('customer_id')
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="date" name="sale_date" class="form-control" value="{{ $sale_invoices->sale_date }}">
                            @error('name')
                            <span class="text-danger">{{ $message }}</span>
                           @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" name="invoice_no" value="{{ $sale_invoices->invoice_no }}" class="form-control" readonly>
                        </div>
                  </div>
                  </div>
                  ...
                  <div class="row">
                     ...
                     <tr>
                       ...
                       <td class="col-lg-3">
                        ...
                        <td class="col-lg-2">
                        <input type="text" value="{{ $info->category->name }}" class="form-control">
                       ...
                       <!-- total purchase and sale price input field -->
                         <input type="hidden" name="total_purchase_price[]" class="total_purchase_price{{$i}}" value="{{($info->quantity*$info->purchase_unit_price)}}">
                         <input type="hidden" name="total_sale_price[]" class="total_sale_price{{$i}}">
                       <!-- total purchase and sale price input field -->
...
<script>
  ...
  $(document).ready(function(){
    //total price
     $(document).on('keyup', '#quantity',function(){
        ...
        var SalePrice =  $(this).closest('tr').find('input.sale_unit_price').val();
  ...
  $(function(){
      ...
      $(document).on('keyup', '.quantity',function(){
          ...
          $('.total_price').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price1
      $(document).on('keyup', '.quantity1',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price1').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price2
      $(document).on('keyup', '.quantity2',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price2').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price3
      $(document).on('keyup', '.quantity3',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price3').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price4
      $(document).on('keyup', '.quantity4',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price4').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price5
      $(document).on('keyup', '.quantity5',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price5').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price6
      $(document).on('keyup', '.quantity6',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price6').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price7
      $(document).on('keyup', '.quantity7',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price7').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price8
      $(document).on('keyup', '.quantity8',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price8').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price9
      $(document).on('keyup', '.quantity9',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price9').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price10
      $(document).on('keyup', '.quantity10',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price10').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price11
      $(document).on('keyup', '.quantity11',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price11').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price12
      $(document).on('keyup', '.quantity12',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price12').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price13
      $(document).on('keyup', '.quantity13',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price13').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price14
      $(document).on('keyup', '.quantity14',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price14').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price15
      $(document).on('keyup', '.quantity15',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price15').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price16
      $(document).on('keyup', '.quantity16',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price16').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price17
      $(document).on('keyup', '.quantity17',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price17').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price18
      $(document).on('keyup', '.quantity18',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price18').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price19
      $(document).on('keyup', '.quantity19',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price19').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price20
      $(document).on('keyup', '.quantity20',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price20').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price21
      $(document).on('keyup', '.quantity21',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price21').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price22
      $(document).on('keyup', '.quantity22',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price22').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price23
      $(document).on('keyup', '.quantity23',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price23').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price24
      $(document).on('keyup', '.quantity24',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price24').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price25
      $(document).on('keyup', '.quantity25',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price25').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price26
      $(document).on('keyup', '.quantity26',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price26').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price27
      $(document).on('keyup', '.quantity27',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price27').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price28
      $(document).on('keyup', '.quantity28',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price28').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price29
      $(document).on('keyup', '.quantity29',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price29').val(TotalSalePrice);
          SubtotalAmountSale();
      });
      //total price30
      $(document).on('keyup', '.quantity30',function(){
          ...
          var TotalSalePrice = Quantity*SaleUnitPrice;
          $('.total_price30').val(TotalSalePrice);
          SubtotalAmountSale();
      });
