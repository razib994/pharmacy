...
<link rel="stylesheet" href="{{ asset('/') }}back-end/data/dataTables.bootstrap4.min.css">
<link rel="stylesheet" href="{{ asset('/') }}back-end/data/custom.css">
...
<!-- Select2 -->
  ...
  <link rel="stylesheet" href="{{ asset('/') }}back-end/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="{{ asset('/') }}back-end/plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
...
<div class="wrapper">
 ...
 <!--  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('/') }}public/back-end/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div> -->
