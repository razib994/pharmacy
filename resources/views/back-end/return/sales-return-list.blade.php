...
<div class="container">
    <div class="row">
	    <div class="col-lg-12">
            <a href="{{ url('sale_return_list_excel') }}" class="excel_btn">
				    ...
				    <tbody>
				        ...
				        <tr>
				            ...
				            <!-- 	<a href="" title="update">
				            	...
				            	<a href="{{ route('sales_reutrn_delete',['id'=>$show->id]) }}" onclick="return confirm('Are you sure?')" title="delete" class="bg-danger">
